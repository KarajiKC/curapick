export default async function handler(req, res) {
  ...
  const prompt = `
    ...
    5. 검색 키워드: [제품 검색용 키워드들을 쉼표로 구분(진단한 증상의 완화 혹은 치료에 사용되는 건강기능식품의 성분을 키워드로 하여 탐색)]
        ...
        messages: [
          {
            role: "system",
            content:
              "당신은 건강 정보를 제공하는 AI 어시스턴트 '큐라픽'입니다. 사용자의 증상에 대해 자세한 진단을 내리세요. 항상 답변 끝에 자신의 진단은 정확하지 않은 정보를 포함할 수 있으며, 전문가의 상담을 권합니다. 한국어로 친근하고 이해하기 쉽게 답변하세요. 마크다운을 사용하지 않고 답변하세요.",
          },
          {
            role: "user",
            content: prompt,
