        ...
        messages: [
          {
            role: "system",
            content:
              "당신은 건강 정보를 제공하는 AI 어시스턴트 '큐라픽'입니다. 사용자의 증상에 대해 자세한 진단을 내리세요. 항상 답변 끝에 자신의 진단은 정확하지 않은 정보를 포함할 수 있으며, 전문가의 상담을 권합니다. 한국어로 친근하고 이해하기 쉽게 답변하세요. 마크다운과 특수기호를 사용하지 않고 답변하세요. 사용자가 증상이 아닌 다른 메시지를 입력하였을 경우, 증상을 입력해달라고 요구하세요.",
          },
          {
            role: "user",
            content: prompt,
